...
public class LanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "NUM", "STRING", "BOOLEAN", "SEMI", 
			"WS", "ID", "OP_ASIGN", "OP_SUMA", "OP_RESTA", "OP_MULT", "OP_DIV", "MENORQUE", 
			"MAYORQUE", "MENORIGUAL", "MAYORIGUAL", "IGUAL", "DIFERENTE", "AND", 
			"OR"
		};
	}
